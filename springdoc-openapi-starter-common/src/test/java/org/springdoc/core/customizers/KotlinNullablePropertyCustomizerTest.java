...
/**
 * Tests for {@link KotlinNullablePropertyCustomizer}.
 *
 * Verifies that the {@code KotlinDetector.isKotlinClass()} guard correctly
 * skips non-Kotlin classes, preventing Kotlin reflection from running on
 * Java DTOs and causing unintended nullable marking.
 */
class KotlinNullablePropertyCustomizerTest {

    private final ObjectMapperProvider mapperProvider = mock(ObjectMapperProvider.class);
    private final KotlinNullablePropertyCustomizer customizer = new KotlinNullablePropertyCustomizer(mapperProvider);

    KotlinNullablePropertyCustomizerTest() {
    ...
    void shouldSkipJavaDto() {
        ...
        // Then: schema returned unchanged — no nullable marking or wrapping
