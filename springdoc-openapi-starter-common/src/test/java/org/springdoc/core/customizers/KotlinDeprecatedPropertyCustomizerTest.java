 ...
 * Java DTOs and causing unintended {@code deprecated} marking.
 */
class KotlinDeprecatedPropertyCustomizerTest {
    ...
    private final KotlinDeprecatedPropertyCustomizer customizer = new KotlinDeprecatedPropertyCustomizer(mapperProvider);

    KotlinDeprecatedPropertyCustomizerTest() {
    ...
    void shouldSkipJavaDto() {
        ...
        // Then: schema returned unchanged — no deprecated marking
