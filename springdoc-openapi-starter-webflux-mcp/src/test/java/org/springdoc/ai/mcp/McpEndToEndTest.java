 ...
 * API endpoints through the MCP tool callback provider in a WebFlux context.
 *
 * <p>
 * This test boots a full reactive web context with a {@code @RestController}, enables the
